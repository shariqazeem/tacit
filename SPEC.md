...
- Proven live on devnet: `npm run preflight:agentic` (vendor) + `preflight:work` (legacy) — see docs/verification-manifest.json; incl. tamper + idempotent replay. Evidence: **[docs/WORK_EVIDENCE.md](docs/WORK_EVIDENCE.md)**.
